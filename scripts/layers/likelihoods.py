...
from .convolutions import NormedSameConv2d, SameConv2d
...
class DiscretizedLogisticLikelihoodConv2d(LikelihoodModule):
    ...
    def __init__(self, input_shape, out_shape, n_bins=256, activation="LeakyReLU", weightnorm=True, double=True):
        ...
        self.parameter_net = SameConv2d(input_shape, 2 * out_shape[0], kernel_size=3)
